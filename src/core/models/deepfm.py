...
from deepctr_ext.basemodel import BaseModel
from deepctr_ext.utils import combined_dnn_input
from deepctr_ext.layers import FM, DNN
...
class DeepFM(BaseModel):
    ...
    def __init__(self,
                 ...
                 l2_reg_linear=0.00001, l2_reg_embedding=0.00001, l2_reg_dnn=0, seed=1024,
                 dnn_dropout=0,
        ...
        super(DeepFM, self).__init__(linear_feature_columns, dnn_feature_columns, l2_reg_linear=l2_reg_linear,
                                     l2_reg_embedding=l2_reg_embedding, seed=seed, task=task,
                                     device=device)
